...
Fork from the project [C14-CLI](https://github.com/online-net/c14-cli)
...
```shell
go get -u github.com/alpagap/c14-rclone/cmd/c14
```
...
3. Fetch the project: `go get -u github.com/alpagap/c14-rclone`
4. Go to c14-cli directory: `cd $GOPATH/src/github.com/alpagap/c14-rclone`
5. Hack: `vim`
6. Build: `make`
7. Run: `./c14`
...
[MIT](https://github.com/alpagap/c14-rclone/blob/master/LICENSE.md)
